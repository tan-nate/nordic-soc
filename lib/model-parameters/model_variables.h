...
const ei_impulse_t impulse_642854_0 = {
    .project_id = 642854,
    .project_owner = "VeriCardSys",
    .project_name = "VeriCardSys-SOC",
    .impulse_id = 1,
    ...
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 97.00208902359009,
    .frequency = 10.309056331320951,
    ...
    .fusion_string = "voltage + current + ah + power + battery_temp + brand",
    .slice_size = (10/4),
...
ei_impulse_handle_t impulse_handle_642854_0 = ei_impulse_handle_t( &impulse_642854_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_642854_0;
