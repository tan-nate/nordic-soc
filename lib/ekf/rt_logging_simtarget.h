...
SLSA_ENGINE_PUBLISHED_C mxClassID rt_GetMxIdFromDTypeIdForRSim(BuiltInDTypeId dTypeID);

SLSA_ENGINE_PUBLISHED_C mxClassID rt_GetMxIdFromDTypeId(BuiltInDTypeId dTypeID);

SLSA_ENGINE_PUBLISHED_C LogVar* rt_CreateLogVarWithConvert(
    RTWLogInfo* li,
...
SLSA_ENGINE_PUBLISHED_C LogVar* rt_CreateLogVar(RTWLogInfo* li,
                                                const real_T startTime,
                                                const real_T finalTime,
                                                const real_T inStepSize,
                                                const char_T** errStatus,
...
SLSA_ENGINE_PUBLISHED_C StructLogVar* rt_CreateStructLogVar(RTWLogInfo* li,
                                                            const real_T startTime,
                                                            const real_T finalTime,
                                                            const real_T inStepSize,
                                                            const char_T** errStatus,
...
SLSA_ENGINE_PUBLISHED_C const char_T* rt_StartDataLoggingWithStartTime(RTWLogInfo* li,
                                                                       const real_T startTime,
                                                                       const real_T finalTime,
                                                                       const real_T stepSize,
                                                                       const char_T** errStatus);

SLSA_ENGINE_PUBLISHED_C const char_T* rt_StartDataLogging(RTWLogInfo* li,
                                                          const real_T finalTime,
                                                          const real_T stepSize,
                                                          const char_T** errStatus);

SLSA_ENGINE_PUBLISHED_C void rt_UpdateLogVar(LogVar* var, const void* data, boolean_T isVarDims);

SLSA_ENGINE_PUBLISHED_C void rt_UpdateStructLogVar(StructLogVar* var,
                                                   const real_T* t,
                                                   const void* data);

SLSA_ENGINE_PUBLISHED_C const char_T* rt_UpdateTXYLogVars(RTWLogInfo* li, time_T* tPtr);
SLSA_ENGINE_PUBLISHED_C const char_T* rt_UpdateTXXFYLogVars(RTWLogInfo* li,
                                                            time_T* tPtr,
                                                            boolean_T updateTXY);

SLSA_ENGINE_PUBLISHED_C void rt_StopDataLoggingImpl(const char_T* file,
                                                    RTWLogInfo* li,
                                                    boolean_T isRaccel,
                                                    boolean_T cleanUp);

SLSA_ENGINE_PUBLISHED_C void rt_StopDataLogging(const char_T* file, RTWLogInfo* li);

SLSA_ENGINE_PUBLISHED_C void rt_DestroyLogInfo(RTWLogInfo* li);
