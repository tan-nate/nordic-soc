...
float simulated_voltage = 4.2;
float simulated_current = -1.0;
float simulated_temperature = 22.0;

void simulate_sensor_readings() {
    simulated_voltage += simulated_current * 0.01;
    if (simulated_voltage <= 2.5) simulated_current = 1.0;
    else if (simulated_voltage >= 4.2) simulated_current = -1.0;
